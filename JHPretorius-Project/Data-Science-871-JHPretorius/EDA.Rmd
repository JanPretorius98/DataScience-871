...
####    Figure 8: Bubble plot of number of pictures in profile and likes received. A non-linear model (loess method) was once again fitted on the plot to discern possible patterns and differences between bios with emojis and those without. Size of dots present how detailed the account is.
...
## Total Data Visualisation

```{r}

# Create a Sankey to visualise all variables
