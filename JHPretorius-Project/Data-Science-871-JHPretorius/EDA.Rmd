...
pacman::p_load(dplyr, ggplot2, tidyverse, rsample, caret, glmnet, vip, pdp, stringr, 
               tidytext, emoji, stopwords, ggridges)
...
df %>% 
  filter(counts_profileVisits < 10000) %>% 
  ggplot(aes(x = factor(has_emoji), y = counts_profileVisits, fill = factor(has_emoji))) +
  geom_boxplot(alpha = 0.5) +
  scale_fill_manual(values = c("#29066b", "#ea7369"), name = "", labels = c("No Emoji", "Contains Emoji")) +
  labs(x = "Contains Emoji", y = "Profile Visits Count") +
  th

df %>% 
  filter(counts_profileVisits < 10000) %>% 
  ggplot(aes(x = factor(contains_popular_word), y = counts_profileVisits, fill = factor(contains_popular_word))) +
  geom_boxplot(alpha = 0.5) +
  scale_fill_manual(values = c("#29066b", "#ea7369"), name = "", labels = c("No Popular Word", "Contains Popular Word")) +
  labs(x = "Contains Popular Word", y = "Profile Visits Count") +
  th

df %>% 
  filter(counts_profileVisits < 10000) %>%
  filter(!is.na(night_owl)) %>% 
  ggplot(aes(x = factor(night_owl), y = counts_profileVisits, fill = factor(night_owl))) +
  geom_boxplot(alpha = 0.5) +
  scale_fill_manual(values = c("#29066b", "#ea7369"), name = "", labels = c("Early Bird", "Night Owl")) +
  labs(x = "Night Owl", y = "Profile Visits Count") +
  th
...
df %>% 
  filter(counts_profileVisits < 10000) %>% 
  ggplot(aes(x = counts_profileVisits, fill = factor(has_emoji))) +
  geom_density(alpha = 0.5) +
  scale_fill_manual(values = c("#29066b", "#ea7369"), name = "", labels = c("No Emoji", "Contains Emoji")) +
  labs(x = "Profile Visits Count", y = "Density", fill = "Contains Emoji") +
  th

df %>% 
  filter(counts_profileVisits < 10000) %>% 
  ggplot(aes(x = counts_profileVisits, fill = factor(contains_popular_word))) +
  geom_density(alpha = 0.5) +
  scale_fill_manual(values = c("#29066b", "#ea7369"), name = "", labels = c("No Popular Word", "Contains Popular Word")) +
  labs(x = "Profile Visits Count", y = "Density", fill = "Contains Popular Word") +
  th

df %>% 
  filter(counts_profileVisits < 10000) %>%
  filter(!is.na(night_owl)) %>% 
  ggplot(aes(x = counts_profileVisits, fill = factor(night_owl))) +
  geom_density(alpha = 0.5) +
  scale_fill_manual(values = c("#29066b", "#ea7369"), name = "", labels = c("Early Bird", "Night Owl")) +
  labs(x = "Night Owl", y = "Profile Visits Count") +
  th
...
df %>%
  ...
  geom_point(aes(fill = factor(has_emoji), size = counts_details), pch = 21, alpha = 0.5) +
  scale_fill_manual(values = c("#29066b", "#ea7369"), name = "Has Emoji", labels = c("No Emoji", "Contains Emoji")) +
  ...
  scale_colour_manual(values = c("#29066b", "#ea7369"), name = "Has Emoji", labels = c("No Emoji", "Contains Emoji"))
